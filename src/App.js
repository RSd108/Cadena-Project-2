  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        <span className="headline-gradient">Radha Coin Project</span>
        <img className="inline p-3 ml-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvCljbP1OzBZykt3AAls_7OlDJ0goe5nxATw&usqp=CAU" alt="Radha Coin" width="60" height="30" />
      </h2>
      <section className="customer-section px-10 pt-5 pb-10">
        {error && <p className="text-2xl text-red-700">{error}</p>}
        <div className="mt-5">
          <span className="mr-5"><strong>Coin:</strong> {tokenName} 
          <img className="inline p-3 ml-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvCljbP1OzBZykt3AAls_7OlDJ0goe5nxATw&usqp=CAU" alt="Radha Coin" width="30" height="15" />
          </span>
